...
async function createCategories() {
	...
	const createPromises = default_categories.map(categoryData => Categories.create(categoryData));
...
async function enableDefaultPlugins() {
	...
	let defaultEnabled = ['nodebb-plugin-composer-default', 'nodebb-plugin-markdown', 'nodebb-plugin-mentions', 'nodebb-plugin-web-push', 'nodebb-widget-essentials', 'nodebb-rewards-essentials', 'nodebb-plugin-emoji', 'nodebb-plugin-emoji-android'];
