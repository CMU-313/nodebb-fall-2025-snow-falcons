...
module.exports = function (app, middleware, controllers) {
  ...
  const middlewares = [middleware.activitypub.enabled, middleware.activitypub.assertS2S, middleware.activitypub.verify, middleware.activitypub.configureResponse];
