...
module.exports = function (Categories) {
	...
	async function updateCategory(cid, modifiedFields) {
		...
		for (const key of fields) {
			// Sequential processing required for field updates
	...
	async function updateHandle(cid, handle) {
		...
		await Promise.all([db.setObjectField(`category:${cid}`, 'handle', handle), db.sortedSetRemove('categoryhandle:cid', existing), db.sortedSetAdd('categoryhandle:cid', cid, handle)]);
	}
};